...
contacts = {
"INFO2290": "Darshvir Singh Dhingra – [ddhingra@conestogac.on.ca](mailto:ddhingra@conestogac.on.ca)",
"INFO2400": "Abdul Samee – [asamee@conestogac.on.ca](mailto:asamee@conestogac.on.ca)",
"INFO2280": "Tariq Mahmood – [tmahmood@conestogac.on.ca](mailto:tmahmood@conestogac.on.ca)",
"INFO2350": "Nikola Cedic – [Ncedic@conestogac.on.ca](mailto:Ncedic@conestogac.on.ca)",
"INFO2390": "Biljana Ivkovic – [bivkovic@conestogac.on.ca](mailto:bivkovic@conestogac.on.ca)"
}
...
"next\_test": "Next test: INFO2290 Test 2 on June 17."
}

# --- Utility Functions ---

def extract\_weekday(query\_text):
query\_text = query\_text.lower()
for day in schedule:
if day in query\_text:
return day
return ""

def extract\_course(query\_text):
pattern = re.compile(r'\binfo\d{4}\b', re.IGNORECASE)
match = pattern.search(query\_text)
if match:
